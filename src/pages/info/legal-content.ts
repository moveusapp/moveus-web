  ...
  sections: [
    {
      ...
      body: [
        ...
        {
          type: "p",
          text: "Questions about these terms? Email us any time at moveus.dev@gmail.com.",
        },
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        {
          type: "p",
          text: "To exercise any of these, just email us at moveus.dev@gmail.com. You can also manage much of your information directly in the app. If you think we've mishandled your data, you have the right to complain to the Croatian data protection authority (AZOP).",
        },
      ],
    },
    {
