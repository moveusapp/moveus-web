...
export function AuthRoutes() {
  ...
  return (
    <div className="flex h-screen bg-base-300">
      <div className="flex flex-col bg-base-100 items-center w-full md:w-[50%] md:max-w-[500px] overflow-y-auto">
        <div className="p-8 flex-shrink-0">
          <img src={moveusLogo} alt="MoveUs" className="h-24" />
        </div>

        <div className="flex-1 mb-16 flex items-center px-8 w-full ">
      ...
      <div className="hidden md:flex flex-1 bg-primary/20 items-center justify-center sticky top-0 h-screen p-12">
